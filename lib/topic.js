...
exports.search = function (request, response) {//api 복수 exports 하나는 module.exports
  var _url = request.url;
  var queryData = url.parse(_url, true).query;
  db.query(`SELECT * FROM topic WHERE title LIKE ? `, '%' + queryData.search + '%', function (error, topics) {
    var title = 'Search';
    var list = template.list(topics);
    var i= 0;
    var body = '';
